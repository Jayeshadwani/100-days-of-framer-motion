                ...
                <span className="animateButtonsWrapper">
                  <span className="animateLikeButtonWrapper">
                    <motion.span
                      ...
                      initial={onTapAnimations.likeWrapper.likeWrapperInitial}
                      animate={onTapAnimations.likeWrapper.likeWrapperAnimation}
                      transition={onTapAnimations.likeWrapper.likeWrapperTransition}>
                      <motion.svg
                        style={{ color: '#dcdcdc' }}
                      ...
                      <motion.span
                        initial={onTapAnimations.wrapperText.initial}
                        animate={onTapAnimations.wrapperText.animate}
                        transition={onTapAnimations.wrapperText.transition}
                        className="gladYouLikedItText">
                        Glad you liked it!
                      </motion.span>
                    </motion.span>
                  </span>
                  <motion.span
                    className="animateDislikeRatingWrapper"
                    animate={onTapAnimations.dislikeButton.animate}
                    initial={onTapAnimations.dislikeButton.initial}
                    transition={onTapAnimations.dislikeButton.transition}>
